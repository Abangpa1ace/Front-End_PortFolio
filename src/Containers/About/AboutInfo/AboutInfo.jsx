    ...
    <ul className="about-info">
      <li className="info-item">
        ...
        <p>
          ...
          육군 20사단 ROTC 장교로 복무하며, 용사 및 간부와 소통하며 부대교육훈련을 기획/추진했습니다.
          포스코 광양제철소 엔지니어로 2년간 근무하며, 담당라인 생산성 향상과 설비 고도화에 기여했습니다.
          주도적인 성장가능성과 유망한 비전에 매료되어 개발자 커리어 전환에 새로이 도전하게 되었습니다. 
        </p>
      </li>
      ...
      <li className="info-item">
        ...
        <p>
          ...
          CSS 및 라이브러리를 통해 적절한 스타일링을 구현하고, React State를 활용한 동적 애니메이션 구현에 대한 고민과 시도를 지향합니다.<br />
          또, 간결하면서도 재활용성 높은 로직 구현을 위해, Javascript 공식문서 학습과 데일리 알고리즘을 통해 메서드 활용과 함수화 역량을 키우고 있습니다.
        </p>
      </li>
